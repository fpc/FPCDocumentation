...
Similat to \var{\$IFDEF}, the  \var{\$IFNDEF} directive will only check the first word of what follows,
all the rest is ignored. This means that code after a
\begin{verbatim}
{$IFNDEF RED}
\end{verbatim}
...
\var{C} is used to specify alignment as by the GNU C compiler. It should 
