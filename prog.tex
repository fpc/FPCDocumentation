...
\item[dirs_<platform>]
This is an extension of the \var{dirs} keyword. It functions in exactly the
same way as \var{dirs} but now you can specify different directories for
different platforms. 
...
dirs_win32=windows
\end{verbatim}
On the \linux platform make will be run in the \var{x11} directory while 
under the \windows platform, make will be run in the \var{windows} directory.
\item[exampledirs] 
...
specify an extension, just the name of the unit as it would appear in a
