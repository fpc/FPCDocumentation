...
By default, the compiler uses shortcut evaluation, i.e.\ the evaluation
...
to change this behaviour: if it's argument is \var{ON}, then the
...
terms as is necessary to determine the outcome.
