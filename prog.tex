...
Procedures and Functions are often called with their parameters on the stack.
...
As of 2.0, the \var{register} modifier is the default calling convention,
prior to that, it was the \var{oldfpcall} convention.
