...
OSDIRINCLUDES+=-Fi${FPCSRCDIR}/rtl/win -Fi${FPCSRCDIR}/rtl/$(OS_SOURCE)
endif 
...
FCLFPVECTORIALDIR=$(FPCSRCDIR)/packages/fpvectorial/src
ifndef OLDGRAPH
...
FCLFPVECTORIAL= --descr=fpvectorial.xml --input="$(FCLFPVECTORIALDIR)/fpvectorial.pas"
