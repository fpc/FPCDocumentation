...
The compiler offers two mechanisms to control whether a property is streamed
...
\end{enumerate}
These two specifiers can both be evaluated to decide whether a property must be
