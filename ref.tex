...
is then stored on the next free bit. Non-ordinal types such as sets, floats, 
strings, (bitpacked) records, (bitpacked) arrays, pointers, classes, objecten, 
procvars, are stored on the first available byte boundary.

Note that the internals of the bitpacking are opaque: they can change
at any tome in the future. What is more: the internal packing depends
