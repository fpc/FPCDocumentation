...
of \fpc 2.7.1. The \var{WideHeaderSize} size is 8 bytes for all versions of
\fpc. \var{L} is the actual length of the string.
...
Widestring  & Pointer size & 2*(L + 1) + WideHeaderSize \\
UnicodeString  & Pointer size & 2*(L + 1) + WideHeaderSize \\
