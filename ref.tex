...
$00000000004001D2
\end{verbatim}
Therefor is is {\em Highly recommended} to always initialize variables
before using them.
...
Any class implementing this interface will therefor need to implement both interfaces:
\begin{verbatim}
