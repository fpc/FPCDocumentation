...
% Comments
\section{Comments}
\index{Comments}\index{Tokens!Symbols}
...
% Numbers
\section{Numbers}
\index{Numbers}\index{Tokens!Numbers}\index{Numbers!Real}
...
\label{se:resourcestring}\index{Resourcestring}\index{Const}\index{Const!String}
...
\index{Types!Array}\index{Array!Static}
...
\index{Record}\index{Types!Record}\index{Fields}
...
\index{File}\index{Text}\index{Types!File}
...
% Pointers
\section{Pointers}
\index{Pointer}\index{Types!Pointer}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Variables}
\index{Variables}\index{Variable}\index{Var}
\label{ch:Variables}
\section{Definition}
...
The prototype declaration of an object is as follows:\index{object}
...
\index{Virtual}\index{Methods!Virtual}
...
\index{Abstract}\index{Methods!Abstract}\index{Methods!Virtual}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Classes}
\label{ch:Classes}\index{Classes}\index{Types!Class}
...
a \var{Protected} section are also accessible to descendent types, even if
they are implemented in other modules.
\item [Public\ ] \index{Public}\index{Visibility!Public} sections are always accessible.
...
\end{verbatim}
Inside a class method, the <var>self</var> identifier points to the
VMT\index{Self}
...
identifiers. Message methods are always virtual.\index{Virtual}
...
The section \index{Private}\index{Published} (\var{private}, \var{published}) in which the specified function or
...
The definition of an Interface has the following form:\index{interface}
...
\index{Statements!Case}\index{Case}
...
\index{Statements!if}\index{If}\index{then}\index{else}
