...
followed by an "=" token  and followed a by an optional expression consisting 
...
run-time.  This is an old concept from Turbo Pascal, which has been 
...
(for Turbo Pascal compatibility). 
...
A special kind of constant declaration block is the \var{Resourestring}
