...
A notable exception to this behaviour is the evaluation of boolean expressions: 
...
This modifier allows you to specify the calling conventions for the Windows
platform: the compiler will then select the correct calling convention
depending on the Windows architecture (cdecl on windows CE or stdcall on all
