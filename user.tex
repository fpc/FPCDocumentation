...
Not all options must be given on the compiler commandline. The compiler
...
It is however possible to compile units such that thet can be smartlinked.
...
boundary. See the programmer's reference for a description of the possible
values.
...
\item[macpas] this unit implements several functions available only in macpas mode. This unit
