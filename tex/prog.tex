...
\item[LEVEL1] Enable some level 1 optimizations. Note that this is not the same as
\var{-O1}, it is a separate flag.
\item[LEVEL2] Enable some level 2 optimizations. Note that this is not the same as
\var{-O2}, it is a separate flag.
\item[LEVEL3] Level 3 optimizations.  Note that this is not the same as
\var{-O3}, it is a separate flag.
\item[LEVEL4] Level 4 optimizations.  Note that this is not the same as
\var{-O4}, it is a separate flag.
