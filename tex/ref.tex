...
\begin{itemize}
\item The string is a short string.
\item The string length is limited to the value given by the specifier which must lie between 1 and 255 (inclusive).
\end{itemize}

The optional codpage specifier in parentheses, e.g. \var{String(1252)}, has a twofold effect:
\begin{itemize}
