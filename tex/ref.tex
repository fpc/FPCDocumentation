...
loop control variable inside the loop. Also, the loop variable is not
defined after the loop finishes. The exception for \var{break} and
\var{exit} also applies.
\end{itemize}
\end{remark}
